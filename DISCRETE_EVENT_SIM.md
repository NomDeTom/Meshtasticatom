...
### Modem
The LoRa modem ([see Meshtastic radio settings](https://meshtastic.org/docs/overview/radio-settings#predefined-channels)) that is used, as defined below. Select one with `--modem-preset`. `Narrow Fast`/`Narrow Slow` are from firmware `develop`. The two `Meshcore` entries share NarrowSlow's SF8/62.5 kHz point but bracket MeshCore's 4/5-to-4/8 coding rate range, so MeshCore community networks can be modelled:
...
| 10 | Narrow Fast | 62.5 | 4/6 | 7 | 2.28 |
| 11 | Narrow Slow | 62.5 | 4/6 | 8 | 1.30 |
| 12 | Meshcore Cr45 | 62.5 | 4/5 | 8 | 1.56 |
| 13 | Meshcore Cr48 | 62.5 | 4/8 | 8 | 0.977 |
