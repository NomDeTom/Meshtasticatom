...
- D-cadence: trigger=interval: misdecodes 11
- D-cadence: trigger=interval: decode_failures 14
- D-cadence: trigger=aimd: misdecodes 1
- D-cadence: trigger=aimd: decode_failures 1
- D-cadence: trigger=bucket+interval: misdecodes 12
- E-capacity: capacity=4: decode_failures 102
- E-capacity: capacity=8: decode_failures 62
- E-capacity: capacity=16: decode_failures 3
- F-burst: burst-loss=0.1: decode_failures 54
- F-burst: burst-loss=0.2: decode_failures 42
- F-burst: burst-loss=0.3: decode_failures 37
- F-flooding: role-mix=baymesh-2026-08: decode_failures 29
- F-hoplimit: hop-limit=3: decode_failures 1
- F-loss: extra-loss=0.2: decode_failures 1
- F-loss: extra-loss=0.3: decode_failures 1
- F-outage: burst-loss=0.1: decode_failures 31
- F-outage: burst-loss=0.2: decode_failures 42
- F-outage: burst-loss=0.3: decode_failures 31
- F-txpower: tx-power=22: decode_failures 8
- F-txpower: tx-power=17: decode_failures 6
- G-hops: hops-apart=3: misdecodes 1
- G-hops: hops-apart=4: decode_failures 35
- G-place: place=spread: decode_failures 2
- J-bucketmode: bucket-mode=global: misdecodes 32
- J-bucketmode: bucket-mode=time: misdecodes 11
- J-bucketmode: bucket-mode=window: misdecodes 18
- J-timewin: time-bucket-s=600: misdecodes 112
- J-timewin: time-bucket-s=1800: misdecodes 11
- J-timewin: time-bucket-s=3600: misdecodes 5
- J-wincap: capacity=8: misdecodes 18
- J-wincap: capacity=8: decode_failures 56
- J-wincap: capacity=16: misdecodes 17
- J-wincap: capacity=16: decode_failures 2
- J-wincap: capacity=32: misdecodes 18
- J-window: window-size=8: misdecodes 157
- J-window: window-size=16: misdecodes 72
- J-window: window-size=32: misdecodes 18
- K-density: nodes=150: decode_failures 5
- K-hopspread: hop-limit=3: decode_failures 1
- K-spread: hop-spread=False: decode_failures 1
- M-capacity: capacity=4: decode_failures 102
- M-capacity: capacity=8: decode_failures 62
- M-capacity: capacity=16: decode_failures 3
- M-combined: replay-ordering=heard: misdecodes 9
- M-replayorder: replay-ordering=heard: misdecodes 10
- N-hops: hops-apart=3: misdecodes 1
- N-hops: hops-apart=4: decode_failures 35
- N-hops: hops-apart=5: decode_failures 25
- N-place: place=spread: decode_failures 2
- P-bw500: preset=SHORT_TURBO: decode_failures 5
- P-bw500: preset=LONG_TURBO: decode_failures 1
- P-catchup: catch-up-hours=: misdecodes 12
- P-catchup: catch-up-hours=02-06: decode_failures 40
- P-catchup: catch-up-hours=00-08: decode_failures 41
- P-congestion: no-congestion-scaling=True: queue drops 15.4% of transmissions - airtime here is measured through a cap
- P-congestion: no-congestion-scaling=True: decode_failures 105
- P-eu-presets: preset=SHORT_FAST: decode_failures 1
- P-eu-presets: preset=NARROW_SLOW: decode_failures 47
- P-preset: preset=SHORT_FAST: decode_failures 1
- P-preset: preset=LONG_MODERATE: decode_failures 5
- Q-control: protocol=sr: misdecodes 1
- R-congestion-input: congestion-input=hotstore: decode_failures 1
- R-congestion-mode: congestion-mode=static: misdecodes 1
- R-crladder: coding-rate-ladder=False: decode_failures 1
- R-crladder: coding-rate-ladder=True: decode_failures 2
- R-dmmode-cr: dm-mode=directed-with-late-flood: decode_failures 2
- R-dmmode-cr: dm-mode=m4-early-flood: decode_failures 9
- R-dmmode: dm-mode=directed-with-late-flood: decode_failures 1
- R-hopscale: nodes=250: decode_failures 2
- R-hopscale: nodes=500: decode_failures 151
- R-hotstore-stress: max-num-nodes=10: decode_failures 92
- R-hotstore-stress: max-num-nodes=120: decode_failures 1
- R-oversubscribed: nodes=250: decode_failures 1
- R-oversubscribed: nodes=500: decode_failures 49
- R-platform: platform-mix=constrained: decode_failures 3
- R-rebroadcast: rebroadcast-mode=CORE_PORTNUMS_ONLY: decode_failures 2
- R-roles: role-mix=baymesh-2026-08: decode_failures 29
- R-signing: signature-policy=STRICT: decode_failures 4
- R-siting: siting-mix=local-typical: decode_failures 3
- R-traceroute-small: traceroute-per-hour=0.0: queue drops 16.2% of transmissions - airtime here is measured through a cap
- R-traceroute-small: traceroute-per-hour=0.0: decode_failures 98
- R-traceroute-small: traceroute-per-hour=1.0: queue drops 25.1% of transmissions - airtime here is measured through a cap
- R-traceroute-small: traceroute-per-hour=1.0: decode_failures 86
- R-versions: profile=2.6: decode_failures 2
- R-warm: warm-num-nodes=0: queue drops 16.2% of transmissions - airtime here is measured through a cap
- R-warm: warm-num-nodes=0: decode_failures 98
- R-warm: warm-num-nodes=25: queue drops 16.2% of transmissions - airtime here is measured through a cap
- R-warm: warm-num-nodes=25: decode_failures 98
- R-warm: warm-num-nodes=100: queue drops 16.2% of transmissions - airtime here is measured through a cap
- R-warm: warm-num-nodes=100: decode_failures 98
- R-warm: warm-num-nodes=2000: queue drops 16.2% of transmissions - airtime here is measured through a cap
- R-warm: warm-num-nodes=2000: decode_failures 98
- X-badrouters: role-placement=degree: decode_failures 29
- X-chatty-hops: broadcast-interval-s=300: queue drops 12.3% of transmissions - airtime here is measured through a cap
- X-chatty-hops: broadcast-interval-s=300: decode_failures 38
- X-chatty: broadcast-interval-s=300: decode_failures 29
- X-noise: noise-profile=temporal: decode_failures 37
- X-nomute: role-mix=baymesh-2026-08: decode_failures 29
- X-pulse: noise-pulse-interval-ms=4000: decode_failures 5
- X-siting: siting-mix=uniform: decode_failures 29
- X-siting: siting-mix=local-typical: decode_failures 22
- X-stretch-duct: duct-per-hour=0.0: decode_failures 7
- X-stretch: stretch=1.25: decode_failures 23
- X-stretch: stretch=1.5: decode_failures 7
- X-stretch: stretch=2.0: decode_failures 2
...
| --- | --- | --- | --- | --: | --- | --- | :-: | --: |
| `Q-control` | protocol | **held** | 0 → 0.988 | 0.988 | 0.879 → 0.889 | 1x bytes_on_air | up | 2 |
| `Q-protocol` | protocol | **held** | 0 → 0.985 | 0.985 | 0.867 → 0.879 | 1.2x bytes_on_air | up | 3 |
| `F-txpower` | tx-power | **held** | 0.146 → 0.985 | 0.839 | 0.075 → 0.879 | 9x sr_airtime | down | 4 |
| `X-pulse` | noise-pulse-interval-ms | **held** | 0.153 → 0.932 | 0.779 | 0.127 → 0.828 | 1e+02x sr_airtime | down | 4 |
| `X-siting` | siting-mix | **held** | 0.163 → 0.922 | 0.759 | 0.045 → 0.795 | 10x sr_bytes | down | 3 |
| `X-stretch` | stretch | **text** | 0.126 → 0.879 | 0.753 | 0.126 → 0.879 | 4.3x advert_bytes | down | 4 |
| `P-bw500` | preset | **held** | 0.217 → 0.951 | 0.734 | 0.150 → 0.809 | 5.1x sr_airtime | up | 3 |
| `R-siting` | siting-mix | **text** | 0.317 → 0.978 | 0.662 | 0.317 → 0.978 | 4.1x sr_airtime | up | 4 |
| `R-hopscale` | nodes | **held** | 0.407 → 0.985 | 0.579 | 0.313 → 0.879 | 8.2x sr_bytes | down | 4 |
| `P-eu-presets` | preset | **text** | 0.367 → 0.879 | 0.512 | 0.367 → 0.879 | 2x sr_airtime | up | 4 |
| `P-preset` | preset | **text** | 0.367 → 0.879 | 0.512 | 0.367 → 0.879 | 2.3x sr_airtime | up | 3 |
| `R-oversubscribed` | nodes | **held** | 0.413 → 0.923 | 0.510 | 0.317 → 0.768 | 4.8x bytes_on_air | down | 3 |
| `Q-topology` | topology | **text** | 0.570 → 0.950 | 0.380 | 0.570 → 0.950 | 2x sr_bytes | up | 4 |
| `X-chatty-hops` | broadcast-interval-s | **text** | 0.591 → 0.936 | 0.345 | 0.591 → 0.936 | 9.2x sr_airtime | down | 3 |
| `X-chatty` | broadcast-interval-s | **text** | 0.561 → 0.906 | 0.345 | 0.561 → 0.906 | 9.8x sr_airtime | down | 3 |
| `F-outage` | burst-loss | **text** | 0.551 → 0.879 | 0.328 | 0.551 → 0.879 | 1.8x sr_bytes | down | 4 |
| `F-burst` | burst-loss | **text** | 0.591 → 0.879 | 0.288 | 0.591 → 0.879 | 2x sr_bytes | down | 4 |
| `X-stretch-duct` | duct-per-hour | **text** | 0.472 → 0.759 | 0.287 | 0.472 → 0.759 | 1.7x sr_airtime | up | 2 |
| `R-hotstore-stress` | max-num-nodes | **held** | 0.643 → 0.928 | 0.286 | 0.340 → 0.557 | 4.6x sr_airtime | up | 3 |
| `P-congestion` | no-congestion-scaling | **text** | 0.714 → 0.961 | 0.247 | 0.714 → 0.961 | 5x sr_airtime | down | 2 |
| `F-hoplimit` | hop-limit | **text** | 0.727 → 0.936 | 0.209 | 0.727 → 0.936 | 2x sr_bytes | up | 4 |
| `K-hopspread` | hop-limit | **text** | 0.727 → 0.926 | 0.198 | 0.727 → 0.926 | 1.9x sr_bytes | up | 3 |
| `K-size` | nodes | **text** | 0.721 → 0.879 | 0.158 | 0.721 → 0.879 | 6.7x sr_bytes | down | 5 |
| `K-spread` | hop-spread | **text** | 0.727 → 0.879 | 0.152 | 0.727 → 0.879 | 1.8x sr_bytes | up | 2 |
| `X-noise` | noise-profile | **text** | 0.729 → 0.879 | 0.150 | 0.729 → 0.879 | 1.6x sr_bytes | down | 4 |
| `K-density` | nodes | **text** | 0.818 → 0.965 | 0.147 | 0.818 → 0.965 | 5.5x sr_airtime | up | 5 |
| `F-flooding` | role-mix | **text** | 0.795 → 0.927 | 0.132 | 0.795 → 0.927 | 2.6x sr_bytes | up | 2 |
| `X-nomute` | role-mix | **text** | 0.795 → 0.927 | 0.132 | 0.795 → 0.927 | 2.6x sr_bytes | up | 3 |
| `R-signing` | signature-policy | **text** | 0.757 → 0.879 | 0.122 | 0.757 → 0.879 | 1.2x sr_airtime | down | 3 |
| `R-hotstore` | max-num-nodes | **text** | 0.816 → 0.917 | 0.100 | 0.816 → 0.917 | 2.2x sr_airtime | up | 4 |
| `F-loss` | extra-loss | **text** | 0.779 → 0.879 | 0.100 | 0.779 → 0.879 | 1.4x sr_bytes | down | 4 |
| `R-platform` | platform-mix | **text** | 0.818 → 0.917 | 0.099 | 0.818 → 0.917 | 2.3x sr_airtime | down | 3 |
| `R-roles` | role-mix | **text** | 0.795 → 0.891 | 0.096 | 0.795 → 0.891 | 1.6x sr_bytes | down | 2 |
| `X-badrouters` | role-placement | **text** | 0.783 → 0.872 | 0.090 | 0.783 → 0.872 | 1.8x sr_bytes | up | 3 |
| `R-roles-fav` | role-mix | **text** | 0.813 → 0.901 | 0.088 | 0.813 → 0.901 | 1.4x sr_bytes | down | 2 |
| `X-amplify-worst` | amplify-worst | **text** | 0.879 → 0.967 | 0.088 | 0.879 → 0.967 | 1.6x sr_bytes | up | 3 |
| `D-cadence` | trigger | **held** | 0.907 → 0.985 | 0.079 | 0.860 → 0.879 | 13x advert_bytes | down | 4 |
| `Q-interval` | broadcast-interval-s | **text** | 0.843 → 0.920 | 0.077 | 0.843 → 0.920 | 4.8x sr_airtime | up | 4 |
| `R-rebroadcast` | rebroadcast-mode | **held** | 0.909 → 0.985 | 0.076 | 0.879 → 0.883 | 19x sr_airtime | down | 3 |
| `R-traceroute-small` | traceroute-per-hour | **text** | 0.635 → 0.706 | 0.071 | 0.635 → 0.706 | 1.3x sr_airtime | down | 2 |
| `X-amplifiers` | amplifier-mix | **text** | 0.879 → 0.950 | 0.071 | 0.879 → 0.950 | 2.5x sr_bytes | up | 3 |
| `X-duct` | duct-per-hour | **text** | 0.879 → 0.947 | 0.067 | 0.879 → 0.947 | 1.6x bytes_on_air | up | 3 |
| `G-place` | place | **text** | 0.866 → 0.921 | 0.054 | 0.866 → 0.921 | 3.6x sr_bytes | down | 6 |
| `N-place` | place | **text** | 0.866 → 0.921 | 0.054 | 0.866 → 0.921 | 3.6x sr_bytes | down | 6 |
| `R-traceroute` | traceroute-per-hour | **text** | 0.832 → 0.885 | 0.052 | 0.832 → 0.885 | 1.5x sr_airtime | down | 4 |
| `P-catchup` | catch-up-hours | **held** | 0.937 → 0.978 | 0.040 | 0.860 → 0.878 | 9.4x advert_bytes | down | 3 |
| `X-worst` | role-placement | **text** | 0.782 → 0.821 | 0.039 | 0.782 → 0.821 | 1.1x sr_bytes | down | 2 |
| `R-signing-cost` | profile-flag | **text** | 0.879 → 0.917 | 0.038 | 0.879 → 0.917 | 3.3x bytes_on_air | down | 2 |
| `R-mixed-26` | legacy-fraction | **text** | 0.879 → 0.917 | 0.038 | 0.879 → 0.917 | 2.2x bytes_on_air | up | 4 |
| `R-versions` | profile | **text** | 0.879 → 0.916 | 0.036 | 0.879 → 0.916 | 3.3x bytes_on_air | down | 5 |
| `L-provide` | provide-transport | **text** | 0.879 → 0.914 | 0.035 | 0.879 → 0.914 | 3.4x sr_airtime | up | 2 |
| `R-mixed` | legacy-fraction | **text** | 0.879 → 0.913 | 0.034 | 0.879 → 0.913 | 2.1x bytes_on_air | up | 4 |
| `R-congestion-input` | congestion-input | **text** | 0.547 → 0.582 | 0.034 | 0.547 → 0.582 | 1.4x sr_airtime | up | 2 |
| `G-hops` | hops-apart | **held** | 0.955 → 0.988 | 0.034 | 0.871 → 0.889 | 3.2x sr_bytes | up | 4 |
| `N-hops` | hops-apart | **held** | 0.955 → 0.988 | 0.034 | 0.871 → 0.893 | 3.2x sr_bytes | up | 5 |
| `J-wincap` | capacity | **held** | 0.955 → 0.986 | 0.031 | 0.882 → 0.883 | 2x advert_bytes | up | 3 |
| `R-firmware` | profile | **text** | 0.879 → 0.910 | 0.031 | 0.879 → 0.910 | 3.2x bytes_on_air | down | 2 |
| `P-diurnal` | diurnal | **text** | 0.879 → 0.903 | 0.024 | 0.879 → 0.903 | 1.3x sr_bytes | down | 3 |
| `R-routerlate` | router-late-fraction | **text** | 0.878 → 0.900 | 0.022 | 0.878 → 0.900 | 1.6x sr_bytes | up | 4 |
| `G-servers` | servers | **held** | 0.971 → 0.993 | 0.022 | 0.879 → 0.887 | 5.4x sr_bytes | up | 4 |
| `N-servers` | servers | **held** | 0.971 → 0.993 | 0.022 | 0.879 → 0.887 | 5.4x sr_bytes | up | 4 |
| `R-srretries` | sr-retries | **text** | 0.865 → 0.882 | 0.017 | 0.865 → 0.882 | 1.2x sr_bytes | down | 4 |
| `R-favourites` | favourite-routers | **text** | 0.881 → 0.895 | 0.014 | 0.881 → 0.895 | 1.1x sr_bytes | up | 2 |
| `J-timewin` | time-bucket-s | **text** | 0.873 → 0.887 | 0.014 | 0.873 → 0.887 | 5.3x advert_bytes | up | 3 |
| `R-dmmode` | dm-mode | **held** | 0.963 → 0.976 | 0.012 | 0.842 → 0.844 | 1.2x sr_airtime | down | 3 |
| `J-window` | window-size | **text** | 0.876 → 0.887 | 0.011 | 0.876 → 0.887 | 5.2x advert_bytes | up | 3 |
| `R-dmmode-cr` | dm-mode | **text** | 0.838 → 0.849 | 0.011 | 0.838 → 0.849 | 1.1x sr_airtime | down | 2 |
| `E-capacity` | capacity | **held** | 0.975 → 0.986 | 0.011 | 0.879 → 0.886 | 5.3x advert_bytes | up | 5 |
| `M-capacity` | capacity | **held** | 0.975 → 0.986 | 0.011 | 0.879 → 0.886 | 5.3x advert_bytes | up | 5 |
| `J-bucketmode` | bucket-mode | **text** | 0.879 → 0.889 | 0.010 | 0.879 → 0.889 | 2.6x advert_bytes | down | 4 |
| `G-allrouters` | servers | **text** | 0.866 → 0.876 | 0.010 | 0.866 → 0.876 | 2.9x sr_bytes | up | 2 |
| `E-width` | short-id-bits | **text** | 0.879 → 0.888 | 0.009 | 0.879 → 0.888 | 3.1x advert_bytes | up | 4 |
| `R-adopt` | no-adopt-hop-recommendation | **text** | 0.952 → 0.961 | 0.009 | 0.952 → 0.961 | 1.2x sr_airtime | down | 2 |
| `Q-hopassign` | hop-assign | **held** | 0.985 → 0.994 | 0.008 | 0.879 → 0.880 | 1.2x sr_airtime | up | 2 |
| `D-resolve` | resolve | **text** | 0.879 → 0.887 | 0.008 | 0.879 → 0.887 | 5.7x advert_bytes | = | 3 |
| `D-jitter` | advert-jitter-s | **held** | 0.981 → 0.988 | 0.007 | 0.878 → 0.885 | 1.1x sr_airtime | down | 4 |
| `M-jitter` | advert-jitter-s | **held** | 0.981 → 0.988 | 0.007 | 0.878 → 0.885 | 1.1x sr_airtime | down | 4 |
| `R-crladder` | coding-rate-ladder | **text** | 0.844 → 0.849 | 0.004 | 0.844 → 0.849 | 1.1x sr_airtime | up | 2 |
| `M-replayorder` | replay-ordering | **text** | 0.879 → 0.882 | 0.003 | 0.879 → 0.882 | 1x sr_bytes | up | 2 |
| `R-repeats` | extra-repeats | **held** | 0.985 → 0.989 | 0.003 | 0.879 → 0.879 | 1x bytes_on_air | up | 2 |
| `L-advert` | advert-transport | **text** | 0.877 → 0.879 | 0.002 | 0.877 → 0.879 | 2.5x sr_airtime | down | 2 |
| `M-combined` | replay-ordering | **held** | 0.983 → 0.986 | 0.002 | 0.914 → 0.916 | 1.1x sr_airtime | up | 2 |
| `R-congestion-mode` | congestion-mode | **text** | 0.961 → 0.963 | 0.002 | 0.961 → 0.963 | 1.1x sr_bytes | down | 2 |
| `R-repeats-busy` | extra-repeats | **text** | 0.960 → 0.961 | 0.001 | 0.960 → 0.961 | 1x sr_airtime | down | 2 |
