...
- SF-cadence: trigger=interval: misdecodes 18
...
- SF-capacity: capacity=4: decode_failures 85
- SF-capacity: capacity=8: decode_failures 45
- SF-capacity: capacity=16: decode_failures 5
- DG-burst: burst-loss=0.2: decode_failures 8
- DG-burst: burst-loss=0.3: decode_failures 20
- DG-loss: extra-loss=0.1: decode_failures 1
...
- RF-txpower: tx-power=22: decode_failures 9
...
- SF-hops-flat: hops-apart=3: decode_failures 32
...
- SF-place-flat: place=beside-router: decode_failures 25
...
- SF-window-size: window-size=8: misdecodes 143
- SF-window-size: window-size=16: misdecodes 59
- SF-window-size: window-size=32: misdecodes 7
- MS-density: nodes=120: decode_failures 75
- MS-density: nodes=150: decode_failures 64
- MS-size: nodes=120: decode_failures 15
- SF-capacity-local: capacity=4: decode_failures 85
- SF-capacity-local: capacity=8: decode_failures 45
- SF-capacity-local: capacity=16: decode_failures 5
- SF-replay-order-broadcast: replay-ordering=heard: misdecodes 5
- SF-replay-order: replay-ordering=heard: misdecodes 11
- SF-hops-spread: hops-apart=3: decode_failures 32
...
- SF-place-spread: place=beside-router: decode_failures 25
...
- TH-congestion: no-congestion-scaling=False: decode_failures 75
- TH-congestion: no-congestion-scaling=True: queue drops 31.3% of transmissions - airtime here is measured through a cap
- TH-congestion: no-congestion-scaling=True: decode_failures 45
- RF-eu-presets: preset=LITE_FAST: decode_failures 1
- RF-eu-presets: preset=NARROW_SLOW: decode_failures 1
- RF-preset: preset=LONG_MODERATE: queue drops 11.2% of transmissions - airtime here is measured through a cap
- RF-preset: preset=LONG_MODERATE: decode_failures 5
- BL-control: protocol=sr: decode_failures 32
- RT-adopt: no-adopt-hop-recommendation=False: decode_failures 75
- RT-adopt: no-adopt-hop-recommendation=True: decode_failures 61
- TH-congestion-input: congestion-input=hotstore: decode_failures 14
- TH-congestion-input: congestion-input=truesize: decode_failures 21
- TH-congestion-mode: congestion-mode=static: decode_failures 9
- TH-congestion-mode: congestion-mode=adaptive: decode_failures 75
- MS-hopscale: nodes=120: decode_failures 15
- MS-hopscale: nodes=250: decode_failures 32
- MS-hopscale: nodes=500: decode_failures 172
- DB-hotstore-stress: max-num-nodes=10: decode_failures 52
- DB-hotstore-stress: max-num-nodes=120: decode_failures 14
- DB-hotstore-stress: max-num-nodes=250: decode_failures 17
- MS-oversubscribed: nodes=120: decode_failures 2
- MS-oversubscribed: nodes=250: decode_failures 14
- MS-oversubscribed: nodes=500: decode_failures 82
- RT-rebroadcast: rebroadcast-mode=CORE_PORTNUMS_ONLY: decode_failures 3
- PR-repeats-busy: extra-repeats=False: decode_failures 75
- PR-repeats-busy: extra-repeats=True: decode_failures 82
- MS-siting: siting-mix=local-typical: decode_failures 18
- MS-siting: siting-mix=backbone: misdecodes 1
- LD-traceroute-small: traceroute-per-hour=0.0: queue drops 33.3% of transmissions - airtime here is measured through a cap
- LD-traceroute-small: traceroute-per-hour=0.0: decode_failures 44
- LD-traceroute-small: traceroute-per-hour=1.0: queue drops 38.7% of transmissions - airtime here is measured through a cap
- LD-traceroute-small: traceroute-per-hour=1.0: decode_failures 48
- DB-warm: warm-num-nodes=0: queue drops 33.3% of transmissions - airtime here is measured through a cap
- DB-warm: warm-num-nodes=0: decode_failures 44
- DB-warm: warm-num-nodes=25: queue drops 33.3% of transmissions - airtime here is measured through a cap
- DB-warm: warm-num-nodes=25: decode_failures 44
- DB-warm: warm-num-nodes=100: queue drops 33.3% of transmissions - airtime here is measured through a cap
- DB-warm: warm-num-nodes=100: decode_failures 44
- DB-warm: warm-num-nodes=2000: queue drops 33.3% of transmissions - airtime here is measured through a cap
- DB-warm: warm-num-nodes=2000: decode_failures 44
- AD-amplify-worst: amplify-worst=0.3: misdecodes 1
...
- LD-chatty: broadcast-interval-s=300: queue drops 23.9% of transmissions - airtime here is measured through a cap
...
- RF-stretch-duct: duct-per-hour=0.0: decode_failures 3
- MS-stretch: stretch=1.5: decode_failures 3
- MS-stretch: stretch=2.0: decode_failures 7
- AD-worst: role-placement=degree: decode_failures 49
- AD-worst: role-placement=inverse: decode_failures 38
...
| --- | --- | --- | --- | --: | --- | --- | :-: | --: |
| `RF-preset-turbo` | preset | **held** | 0.000 → 0.880 | 0.880 | 0.018 → 0.696 | 4.7x bytes_on_air | up | 5 |
| `PR-protocol` | protocol | **held** | 0 → 0.880 | 0.880 | 0.670 → 0.696 | 1.1x bytes_on_air | up | 3 |
| `MS-siting` | siting-mix | **held** | 0.140 → 0.986 | 0.846 | 0.127 → 0.949 | 30x sr_bytes | up | 4 |
| `RF-txpower` | tx-power | **held** | 0.040 → 0.880 | 0.840 | 0.027 → 0.696 | 90x sr_bytes | down | 4 |
| `BL-control` | protocol | **held** | 0 → 0.791 | 0.791 | 0.687 → 0.699 | 1.1x bytes_on_air | up | 2 |
| `RF-pulse` | noise-pulse-interval-ms | **held** | 0.001 → 0.779 | 0.778 | 0.002 → 0.612 | 5.3x bytes_on_air | down | 4 |
| `MS-stretch` | stretch | **held** | 0.118 → 0.880 | 0.762 | 0.070 → 0.696 | 8x advert_bytes | down | 4 |
| `AD-siting` | siting-mix | **held** | 0.220 → 0.859 | 0.639 | 0.035 → 0.649 | 4.1x sr_bytes | down | 3 |
| `MS-hopscale` | nodes | **held** | 0.290 → 0.880 | 0.590 | 0.175 → 0.696 | 8.5x sr_bytes | down | 4 |
| `RF-bw500` | preset | **held** | 0.210 → 0.796 | 0.586 | 0.122 → 0.598 | 10x sr_bytes | up | 3 |
| `LD-chatty` | broadcast-interval-s | **held** | 0.416 → 0.926 | 0.510 | 0.295 → 0.745 | 25x sr_airtime | down | 3 |
| `LD-chatty-hops` | broadcast-interval-s | **text** | 0.332 → 0.832 | 0.500 | 0.332 → 0.832 | 18x sr_airtime | down | 3 |
| `RF-eu-presets` | preset | **text** | 0.238 → 0.724 | 0.486 | 0.238 → 0.724 | 2.5x sr_bytes | up | 4 |
| `RF-preset` | preset | **text** | 0.238 → 0.696 | 0.458 | 0.238 → 0.696 | 2.4x sr_airtime | up | 3 |
| `MS-topology` | topology | **text** | 0.489 → 0.919 | 0.431 | 0.489 → 0.919 | 2.2x sr_bytes | up | 4 |
| `RF-stretch-duct` | duct-per-hour | **text** | 0.213 → 0.619 | 0.406 | 0.213 → 0.619 | 2.5x sr_airtime | up | 2 |
| `TH-congestion` | no-congestion-scaling | **held** | 0.550 → 0.941 | 0.391 | 0.451 → 0.836 | 6.6x sr_airtime | down | 2 |
| `MS-oversubscribed` | nodes | **held** | 0.293 → 0.660 | 0.367 | 0.175 → 0.467 | 4x bytes_on_air | down | 3 |
| `RT-hoplimit` | hop-limit | **text** | 0.491 → 0.845 | 0.353 | 0.491 → 0.845 | 2.9x sr_bytes | up | 4 |
| `MS-density` | nodes | **held** | 0.647 → 0.978 | 0.331 | 0.547 → 0.846 | 6x advert_bytes | up | 5 |
| `DG-outage` | burst-loss | **text** | 0.367 → 0.696 | 0.329 | 0.367 → 0.696 | 1.9x sr_bytes | down | 4 |
| `RT-hopspread` | hop-limit | **text** | 0.491 → 0.785 | 0.294 | 0.491 → 0.785 | 2.2x sr_bytes | up | 3 |
| `DG-burst` | burst-loss | **text** | 0.417 → 0.696 | 0.279 | 0.417 → 0.696 | 1.8x sr_bytes | down | 4 |
| `MS-size` | nodes | **text** | 0.420 → 0.696 | 0.276 | 0.420 → 0.696 | 4.3x sr_bytes | down | 5 |
| `DB-hotstore-stress` | max-num-nodes | **held** | 0.307 → 0.567 | 0.260 | 0.186 → 0.300 | 5.5x sr_airtime | up | 3 |
| `RF-noise` | noise-profile | **held** | 0.624 → 0.880 | 0.256 | 0.466 → 0.696 | 1.6x sr_airtime | down | 4 |
| `RT-spread` | hop-spread | **text** | 0.491 → 0.696 | 0.205 | 0.491 → 0.696 | 1.7x sr_bytes | up | 2 |
| `SF-hops-spread` | hops-apart | **held** | 0.686 → 0.880 | 0.193 | 0.682 → 0.707 | 2.6x sr_bytes | down | 5 |
| `AD-amplify-worst` | amplify-worst | **text** | 0.696 → 0.888 | 0.192 | 0.696 → 0.888 | 1.4x sr_airtime | up | 3 |
| `AD-amplifiers` | amplifier-mix | **text** | 0.696 → 0.885 | 0.189 | 0.696 → 0.885 | 1.5x sr_bytes | up | 3 |
| `SF-place-flat` | place | **held** | 0.700 → 0.880 | 0.180 | 0.688 → 0.700 | 2.1x sr_bytes | up | 6 |
| `SF-place-spread` | place | **held** | 0.700 → 0.880 | 0.180 | 0.688 → 0.700 | 2.1x sr_bytes | up | 6 |
| `SF-servers-allrouters` | servers | **held** | 0.767 → 0.944 | 0.177 | 0.696 → 0.751 | 4.9x sr_bytes | up | 2 |
| `SF-hops-flat` | hops-apart | **held** | 0.703 → 0.880 | 0.177 | 0.682 → 0.707 | 2.6x sr_bytes | down | 4 |
| `RF-duct` | duct-per-hour | **text** | 0.696 → 0.862 | 0.166 | 0.696 → 0.862 | 1.5x bytes_on_air | up | 3 |
| `LD-interval` | broadcast-interval-s | **text** | 0.625 → 0.787 | 0.163 | 0.625 → 0.787 | 6x sr_airtime | up | 4 |
| `DG-loss` | extra-loss | **text** | 0.538 → 0.696 | 0.158 | 0.538 → 0.696 | 1.3x sr_bytes | down | 4 |
| `DB-hotstore` | max-num-nodes | **text** | 0.622 → 0.752 | 0.130 | 0.622 → 0.752 | 2.1x sr_airtime | up | 4 |
| `DB-platform` | platform-mix | **text** | 0.622 → 0.752 | 0.130 | 0.622 → 0.752 | 2.1x sr_airtime | down | 3 |
| `FW-mixed` | legacy-fraction | **text** | 0.684 → 0.777 | 0.093 | 0.684 → 0.777 | 1.9x bytes_on_air | up | 4 |
| `SC-signing` | signature-policy | **text** | 0.605 → 0.696 | 0.091 | 0.605 → 0.696 | 1.2x sr_airtime | down | 3 |
| `AD-flooding` | role-mix | **text** | 0.649 → 0.739 | 0.089 | 0.649 → 0.739 | 2.4x bytes_on_air | up | 2 |
| `AD-nomute` | role-mix | **text** | 0.649 → 0.739 | 0.089 | 0.649 → 0.739 | 2.4x bytes_on_air | up | 3 |
| `FW-mixed-26` | legacy-fraction | **text** | 0.684 → 0.770 | 0.086 | 0.684 → 0.770 | 1.9x bytes_on_air | up | 4 |
| `FW-firmware` | profile | **text** | 0.696 → 0.778 | 0.082 | 0.696 → 0.778 | 3.2x bytes_on_air | down | 2 |
| `FW-versions` | profile | **text** | 0.696 → 0.777 | 0.081 | 0.696 → 0.777 | 3.3x bytes_on_air | down | 5 |
| `RT-rebroadcast` | rebroadcast-mode | **held** | 0.811 → 0.880 | 0.069 | 0.695 → 0.696 | 13x sr_airtime | down | 3 |
| `FW-signing-cost` | profile-flag | **text** | 0.696 → 0.764 | 0.068 | 0.696 → 0.764 | 3.3x bytes_on_air | down | 2 |
| `TH-congestion-input` | congestion-input | **held** | 0.566 → 0.632 | 0.065 | 0.298 → 0.335 | 2.2x sr_airtime | up | 2 |
| `SF-cadence` | trigger | **held** | 0.819 → 0.880 | 0.061 | 0.651 → 0.696 | 14x advert_bytes | down | 4 |
| `LD-traceroute` | traceroute-per-hour | **text** | 0.640 → 0.696 | 0.056 | 0.640 → 0.696 | 1.4x sr_airtime | down | 4 |
| `RT-favourites` | favourite-routers | **text** | 0.695 → 0.750 | 0.056 | 0.695 → 0.750 | 1.1x sr_bytes | up | 2 |
| `MS-roles-fav` | role-mix | **held** | 0.839 → 0.894 | 0.055 | 0.699 → 0.714 | 1.3x sr_bytes | down | 2 |
| `SF-servers-flat` | servers | **held** | 0.854 → 0.909 | 0.055 | 0.691 → 0.712 | 9.8x sr_bytes | up | 4 |
| `SF-servers-spread` | servers | **held** | 0.854 → 0.909 | 0.055 | 0.691 → 0.712 | 9.8x sr_bytes | up | 4 |
| `RT-hopassign` | hop-assign | **text** | 0.652 → 0.696 | 0.044 | 0.652 → 0.696 | 1.6x sr_airtime | down | 2 |
| `LD-traceroute-small` | traceroute-per-hour | **held** | 0.489 → 0.532 | 0.042 | 0.401 → 0.436 | 1.1x sr_bytes | down | 2 |
| `MS-roles` | role-mix | **held** | 0.859 → 0.894 | 0.035 | 0.649 → 0.682 | 1.1x sr_bytes | down | 2 |
| `SF-catchup` | catch-up-hours | **text** | 0.655 → 0.689 | 0.034 | 0.655 → 0.689 | 9.2x advert_bytes | up | 3 |
| `TH-congestion-mode` | congestion-mode | **held** | 0.941 → 0.975 | 0.033 | 0.836 → 0.849 | 1.2x sr_airtime | down | 2 |
| `SF-capacity` | capacity | **held** | 0.848 → 0.880 | 0.032 | 0.680 → 0.701 | 5.4x advert_bytes | up | 5 |
| `SF-capacity-local` | capacity | **held** | 0.848 → 0.880 | 0.032 | 0.680 → 0.701 | 5.4x advert_bytes | up | 5 |
| `SF-provide-transport` | provide-transport | **text** | 0.696 → 0.726 | 0.030 | 0.696 → 0.726 | 3.1x sr_airtime | up | 2 |
| `LD-diurnal` | diurnal | **text** | 0.696 → 0.726 | 0.030 | 0.696 → 0.726 | 1.2x advert_bytes | down | 3 |
| `SF-bucket-time` | time-bucket-s | **held** | 0.850 → 0.879 | 0.029 | 0.675 → 0.696 | 5.1x advert_bytes | up | 3 |
| `SF-sr-retries` | sr-retries | **held** | 0.855 → 0.883 | 0.028 | 0.688 → 0.701 | 1.2x sr_bytes | down | 4 |
| `PR-dmmode-cr` | dm-mode | **held** | 0.840 → 0.863 | 0.023 | 0.653 → 0.655 | 1.2x sr_airtime | up | 2 |
| `AD-badrouters` | role-placement | **held** | 0.849 → 0.871 | 0.022 | 0.629 → 0.649 | 1.3x sr_bytes | down | 3 |
| `SF-jitter-global` | advert-jitter-s | **held** | 0.869 → 0.889 | 0.020 | 0.691 → 0.703 | 1.1x sr_bytes | down | 4 |
| `SF-jitter-local` | advert-jitter-s | **held** | 0.869 → 0.889 | 0.020 | 0.691 → 0.703 | 1.1x sr_bytes | down | 4 |
| `MS-router-late` | router-late-fraction | **held** | 0.861 → 0.880 | 0.019 | 0.695 → 0.706 | 1.3x bytes_on_air | down | 4 |
| `DM-mode` | dm-mode | **held** | 0.834 → 0.852 | 0.018 | 0.641 → 0.655 | 1.2x sr_airtime | up | 3 |
| `AD-worst` | role-placement | **held** | 0.867 → 0.881 | 0.014 | 0.709 → 0.723 | 1.1x sr_airtime | up | 2 |
| `RT-adopt` | no-adopt-hop-recommendation | **held** | 0.927 → 0.941 | 0.014 | 0.823 → 0.836 | 1.1x sr_airtime | down | 2 |
| `SF-capacity-window` | capacity | **held** | 0.862 → 0.873 | 0.011 | 0.690 → 0.696 | 1.8x advert_bytes | up | 3 |
| `PR-crladder` | coding-rate-ladder | **text** | 0.645 → 0.653 | 0.008 | 0.645 → 0.653 | 1.1x sr_bytes | up | 2 |
| `SF-resolve` | resolve | **held** | 0.872 → 0.880 | 0.008 | 0.690 → 0.696 | 5.7x advert_bytes | = | 3 |
| `SF-width` | short-id-bits | **held** | 0.873 → 0.880 | 0.007 | 0.690 → 0.696 | 3.1x advert_bytes | up | 4 |
| `SF-bucket-mode` | bucket-mode | **held** | 0.873 → 0.880 | 0.007 | 0.690 → 0.696 | 3.9x advert_bytes | down | 4 |
| `PR-repeats` | extra-repeats | **held** | 0.873 → 0.880 | 0.007 | 0.693 → 0.696 | 1x sr_airtime | down | 2 |
| `PR-repeats-busy` | extra-repeats | **text** | 0.829 → 0.836 | 0.006 | 0.829 → 0.836 | 1.1x sr_bytes | down | 2 |
| `SF-window-size` | window-size | **text** | 0.690 → 0.696 | 0.006 | 0.690 → 0.696 | 6.6x advert_bytes | up | 3 |
| `SF-advert-transport` | advert-transport | **text** | 0.696 → 0.700 | 0.004 | 0.696 → 0.700 | 2x advert_bytes | up | 2 |
| `SF-replay-order` | replay-ordering | **held** | 0.877 → 0.880 | 0.003 | 0.696 → 0.699 | 1.1x sr_bytes | down | 2 |
| `SF-replay-order-broadcast` | replay-ordering | **held** | 0.871 → 0.874 | 0.003 | 0.724 → 0.726 | 1x sr_airtime | up | 2 |
