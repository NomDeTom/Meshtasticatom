...
- D-cadence: trigger=interval: misdecodes 26
- D-cadence: trigger=aimd: misdecodes 1
- D-cadence: trigger=bucket+interval: misdecodes 32
- E-capacity: capacity=4: decode_failures 78
- E-capacity: capacity=8: decode_failures 55
- E-capacity: capacity=16: decode_failures 3
- F-burst: burst-loss=0.2: decode_failures 3
- F-burst: burst-loss=0.3: decode_failures 20
- F-outage: burst-loss=0.1: decode_failures 30
- F-outage: burst-loss=0.2: decode_failures 46
- F-outage: burst-loss=0.3: decode_failures 33
- F-txpower: tx-power=22: decode_failures 22
- F-txpower: tx-power=14: decode_failures 4
- G-allrouters: servers=6: misdecodes 2
- G-hops: hops-apart=3: decode_failures 11
- G-hops: hops-apart=4: decode_failures 20
- G-place: place=spread: decode_failures 34
- G-place: place=random-clients: decode_failures 34
- G-servers: servers=8: misdecodes 1
- J-bucketmode: bucket-mode=global: misdecodes 42
- J-bucketmode: bucket-mode=time: misdecodes 44
- J-bucketmode: bucket-mode=window: misdecodes 20
- J-timewin: time-bucket-s=600: misdecodes 106
- J-timewin: time-bucket-s=1800: misdecodes 44
- J-timewin: time-bucket-s=3600: misdecodes 11
- J-wincap: capacity=8: misdecodes 18
- J-wincap: capacity=8: decode_failures 21
- J-wincap: capacity=16: misdecodes 24
- J-wincap: capacity=16: decode_failures 1
- J-wincap: capacity=32: misdecodes 20
- J-window: window-size=8: misdecodes 149
- J-window: window-size=16: misdecodes 72
- J-window: window-size=32: misdecodes 20
- K-size: nodes=120: decode_failures 68
- K-size: nodes=150: decode_failures 9
- K-size: slower: 8.61 s per simulated hour against 3.4 over 4 prior run(s) - 2.5x, and a runtime regression is invisible to `timeout-minutes` until it fails a job outright
- M-capacity: capacity=4: decode_failures 78
- M-capacity: capacity=8: decode_failures 55
- M-capacity: capacity=16: decode_failures 3
- M-combined: replay-ordering=heard: misdecodes 14
- M-replayorder: replay-ordering=heard: misdecodes 21
- N-hops: hops-apart=3: decode_failures 11
- N-hops: hops-apart=4: decode_failures 20
- N-hops: hops-apart=5: decode_failures 19
- N-place: place=spread: decode_failures 34
- N-place: place=random-clients: decode_failures 34
- N-servers: servers=8: misdecodes 1
- P-bw500: preset=MEDIUM_TURBO: decode_failures 13
- P-catchup: catch-up-hours=: misdecodes 32
- P-catchup: catch-up-hours=02-06: decode_failures 5
- P-catchup: catch-up-hours=00-08: misdecodes 1
- P-catchup: catch-up-hours=00-08: decode_failures 5
- P-catchup: faster: 4.79 s per simulated hour against 10.1 over 4 prior run(s) - 2.1x quicker, which is worth a look: a fragmented mesh or an arm that stopped being read both cost less to simulate
- P-congestion: no-congestion-scaling=True: queue drops 11.5% of transmissions - airtime here is measured through a cap
- P-congestion: no-congestion-scaling=True: decode_failures 83
- P-eu-presets: preset=SHORT_FAST: decode_failures 14
- P-preset: preset=SHORT_FAST: decode_failures 14
- P-preset: preset=LONG_MODERATE: decode_failures 3
- Q-control: protocol=sr: decode_failures 11
- Q-topology: topology=clustered: misdecodes 1
- R-congestion-input: faster: 9.11 s per simulated hour against 18.5 over 4 prior run(s) - 2.0x quicker, which is worth a look: a fragmented mesh or an arm that stopped being read both cost less to simulate
- R-hopscale: nodes=120: decode_failures 68
- R-hopscale: nodes=500: decode_failures 55
- R-hotstore: max-num-nodes=10: decode_failures 1
- R-hotstore-stress: max-num-nodes=10: decode_failures 3
- R-mixed: legacy-fraction=0.75: misdecodes 1
- R-oversubscribed: nodes=120: decode_failures 34
- R-oversubscribed: nodes=500: decode_failures 76
- R-platform: platform-mix=constrained: decode_failures 1
- R-siting: siting-mix=backbone: misdecodes 1
- R-traceroute-small: traceroute-per-hour=0.0: queue drops 12.9% of transmissions - airtime here is measured through a cap
- R-traceroute-small: traceroute-per-hour=0.0: decode_failures 111
- R-traceroute-small: traceroute-per-hour=1.0: queue drops 20.4% of transmissions - airtime here is measured through a cap
- R-traceroute-small: traceroute-per-hour=1.0: decode_failures 85
- R-warm: warm-num-nodes=0: queue drops 12.9% of transmissions - airtime here is measured through a cap
- R-warm: warm-num-nodes=0: decode_failures 111
- R-warm: warm-num-nodes=25: queue drops 12.9% of transmissions - airtime here is measured through a cap
- R-warm: warm-num-nodes=25: decode_failures 111
- R-warm: warm-num-nodes=100: queue drops 12.9% of transmissions - airtime here is measured through a cap
- R-warm: warm-num-nodes=100: decode_failures 111
- R-warm: warm-num-nodes=2000: queue drops 12.9% of transmissions - airtime here is measured through a cap
- R-warm: warm-num-nodes=2000: decode_failures 111
- X-amplifiers: amplifier-mix=sprinkled: misdecodes 1
- X-amplify-worst: amplify-worst=0.1: decode_failures 3
- X-badrouters: role-placement=inverse: decode_failures 5
- X-chatty-hops: broadcast-interval-s=300: decode_failures 4
- X-chatty: broadcast-interval-s=300: decode_failures 13
- X-noise: noise-profile=transient: misdecodes 1
- X-pulse: noise-pulse-interval-ms=4000: decode_failures 2
- X-siting: siting-mix=local-typical: decode_failures 13
- X-siting: slower: 2.72 s per simulated hour against 1.3 over 4 prior run(s) - 2.1x, and a runtime regression is invisible to `timeout-minutes` until it fails a job outright
- X-stretch-duct: duct-per-hour=0.0: decode_failures 8
- X-stretch-duct: duct-per-hour=1.0: decode_failures 1
- X-stretch: stretch=1.25: decode_failures 40
- X-stretch: stretch=1.5: decode_failures 8
- X-stretch: stretch=2.0: decode_failures 1
- X-worst: role-placement=inverse: decode_failures 3
- X-worst: faster: 4.84 s per simulated hour against 10.7 over 4 prior run(s) - 2.2x quicker, which is worth a look: a fragmented mesh or an arm that stopped being read both cost less to simulate
...
| --- | --: | --: | --: | --: |
| `K-size` | 8.61 | 3.4 | 2.53x | 4 |
| `X-siting` | 2.72 | 1.3 | 2.09x | 4 |
| `Q-control` | 3.79 | 1.93 | 1.96x | 4 |
| `F-txpower` | 3.2 | 1.7 | 1.89x | 4 |
| `G-place` | 5.02 | 2.97 | 1.69x | 4 |
| `P-bw500` | 3.37 | 2.04 | 1.65x | 4 |
| `N-place` | 4.85 | 2.96 | 1.64x | 4 |
| `X-amplify-worst` | 2.59 | 1.67 | 1.55x | 4 |
| `R-oversubscribed` | 30 | 19.8 | 1.52x | 4 |
| `R-dmmode-cr` | 1.75 | 2.83 | 0.62x | 4 |
| `X-chatty-hops` | 2.39 | 4.21 | 0.57x | 4 |
| `R-hotstore-stress` | 15.7 | 28.9 | 0.54x | 4 |
| `R-congestion-input` | 9.11 | 18.5 | 0.49x | 4 |
| `P-catchup` | 4.79 | 10.1 | 0.47x | 4 |
| `X-worst` | 4.84 | 10.7 | 0.45x | 4 |
...
| --- | --- | --- | --- | --: | --- | --- | :-: | --: |
| `Q-control` | protocol | **held** | 0 → 0.936 | 0.936 | 0.742 → 0.805 | 1.1x bytes_on_air | up | 2 |
| `Q-protocol` | protocol | **held** | 0 → 0.915 | 0.915 | 0.738 → 0.760 | 1.2x bytes_on_air | up | 3 |
| `R-siting` | siting-mix | **text** | 0.135 → 0.960 | 0.825 | 0.135 → 0.960 | 5x sr_airtime | up | 4 |
| `X-siting` | siting-mix | **held** | 0.151 → 0.928 | 0.777 | 0.113 → 0.692 | 6.4x advert_bytes | down | 3 |
| `X-pulse` | noise-pulse-interval-ms | **held** | 0.104 → 0.861 | 0.756 | 0.095 → 0.708 | 1.4e+02x sr_airtime | down | 4 |
| `F-txpower` | tx-power | **held** | 0.260 → 0.915 | 0.655 | 0.106 → 0.760 | 3.8x advert_bytes | down | 4 |
| `X-stretch` | stretch | **text** | 0.139 → 0.760 | 0.621 | 0.139 → 0.760 | 3.4x sr_airtime | down | 4 |
| `K-density` | nodes | **text** | 0.378 → 0.959 | 0.581 | 0.378 → 0.959 | 8.9x sr_airtime | up | 5 |
| `R-hopscale` | nodes | **held** | 0.394 → 0.915 | 0.521 | 0.312 → 0.760 | 8.9x sr_bytes | down | 4 |
| `Q-topology` | topology | **text** | 0.456 → 0.956 | 0.500 | 0.456 → 0.956 | 2.6x sr_airtime | up | 4 |
| `P-eu-presets` | preset | **text** | 0.269 → 0.760 | 0.491 | 0.269 → 0.760 | 2.3x sr_airtime | up | 4 |
| `P-preset` | preset | **text** | 0.269 → 0.760 | 0.491 | 0.269 → 0.760 | 3.2x sr_airtime | up | 3 |
| `R-oversubscribed` | nodes | **held** | 0.400 → 0.860 | 0.461 | 0.316 → 0.756 | 4.6x bytes_on_air | down | 3 |
| `P-bw500` | preset | **text** | 0.200 → 0.632 | 0.432 | 0.200 → 0.632 | 1.9x sr_bytes | up | 3 |
| `X-chatty-hops` | broadcast-interval-s | **text** | 0.502 → 0.829 | 0.326 | 0.502 → 0.829 | 9.4x sr_airtime | down | 3 |
| `X-stretch-duct` | duct-per-hour | **text** | 0.334 → 0.658 | 0.324 | 0.334 → 0.658 | 2x sr_airtime | up | 2 |
| `X-chatty` | broadcast-interval-s | **text** | 0.481 → 0.791 | 0.310 | 0.481 → 0.791 | 7.5x sr_airtime | down | 3 |
| `F-outage` | burst-loss | **text** | 0.463 → 0.760 | 0.297 | 0.463 → 0.760 | 2.6x sr_bytes | down | 4 |
| `F-burst` | burst-loss | **text** | 0.470 → 0.760 | 0.290 | 0.470 → 0.760 | 2.3x sr_bytes | down | 4 |
| `R-hotstore-stress` | max-num-nodes | **held** | 0.409 → 0.660 | 0.251 | 0.308 → 0.506 | 5.1x sr_airtime | up | 3 |
| `F-hoplimit` | hop-limit | **text** | 0.574 → 0.820 | 0.245 | 0.574 → 0.820 | 1.4x bytes_on_air | up | 4 |
| `K-hopspread` | hop-limit | **text** | 0.574 → 0.808 | 0.234 | 0.574 → 0.808 | 1.3x bytes_on_air | up | 3 |
| `X-amplifiers` | amplifier-mix | **text** | 0.760 → 0.966 | 0.206 | 0.760 → 0.966 | 1.3x sr_airtime | up | 3 |
| `P-congestion` | no-congestion-scaling | **text** | 0.762 → 0.959 | 0.197 | 0.762 → 0.959 | 4.8x sr_airtime | down | 2 |
| `N-hops` | hops-apart | **held** | 0.746 → 0.936 | 0.191 | 0.749 → 0.805 | 2.9x sr_bytes | down | 5 |
| `K-spread` | hop-spread | **text** | 0.574 → 0.760 | 0.186 | 0.574 → 0.760 | 1.3x advert_bytes | up | 2 |
| `X-amplify-worst` | amplify-worst | **text** | 0.760 → 0.930 | 0.170 | 0.760 → 0.930 | 2x sr_bytes | up | 3 |
| `F-flooding` | role-mix | **text** | 0.692 → 0.862 | 0.169 | 0.692 → 0.862 | 2.5x bytes_on_air | up | 2 |
| `X-nomute` | role-mix | **text** | 0.692 → 0.862 | 0.169 | 0.692 → 0.862 | 2.5x bytes_on_air | up | 3 |
| `X-noise` | noise-profile | **held** | 0.749 → 0.915 | 0.166 | 0.598 → 0.760 | 1.4x sr_airtime | down | 4 |
| `R-signing` | signature-policy | **text** | 0.604 → 0.760 | 0.156 | 0.604 → 0.760 | 1.3x sr_airtime | down | 3 |
| `G-hops` | hops-apart | **held** | 0.791 → 0.936 | 0.145 | 0.749 → 0.805 | 2.9x sr_bytes | down | 4 |
| `F-loss` | extra-loss | **text** | 0.627 → 0.760 | 0.133 | 0.627 → 0.760 | 1.5x sr_bytes | down | 4 |
| `X-duct` | duct-per-hour | **text** | 0.760 → 0.891 | 0.130 | 0.760 → 0.891 | 1.4x bytes_on_air | up | 3 |
| `Q-interval` | broadcast-interval-s | **text** | 0.701 → 0.830 | 0.128 | 0.701 → 0.830 | 5.6x sr_airtime | up | 4 |
| `R-hotstore` | max-num-nodes | **text** | 0.645 → 0.773 | 0.128 | 0.645 → 0.773 | 2.2x sr_airtime | up | 4 |
| `R-platform` | platform-mix | **text** | 0.649 → 0.773 | 0.124 | 0.649 → 0.773 | 2.2x sr_airtime | down | 3 |
| `G-place` | place | **held** | 0.792 → 0.915 | 0.123 | 0.746 → 0.799 | 5.8x sr_bytes | up | 6 |
| `N-place` | place | **held** | 0.792 → 0.915 | 0.123 | 0.746 → 0.799 | 5.8x sr_bytes | up | 6 |
| `K-size` | nodes | **text** | 0.714 → 0.808 | 0.094 | 0.714 → 0.808 | 7.5x sr_bytes | down | 5 |
| `X-badrouters` | role-placement | **text** | 0.611 → 0.692 | 0.081 | 0.611 → 0.692 | 1.2x sr_bytes | down | 3 |
| `R-traceroute-small` | traceroute-per-hour | **text** | 0.673 → 0.746 | 0.073 | 0.673 → 0.746 | 1.3x sr_airtime | down | 2 |
| `R-mixed` | legacy-fraction | **text** | 0.750 → 0.822 | 0.072 | 0.750 → 0.822 | 2x bytes_on_air | up | 4 |
| `R-roles` | role-mix | **text** | 0.692 → 0.763 | 0.071 | 0.692 → 0.763 | 1.4x sr_bytes | down | 2 |
| `R-mixed-26` | legacy-fraction | **held** | 0.915 → 0.985 | 0.070 | 0.757 → 0.817 | 2.1x bytes_on_air | up | 4 |
| `R-routerlate` | router-late-fraction | **text** | 0.735 → 0.798 | 0.063 | 0.735 → 0.798 | 1.4x bytes_on_air | up | 4 |
| `R-rebroadcast` | rebroadcast-mode | **held** | 0.857 → 0.915 | 0.058 | 0.749 → 0.760 | 22x sr_airtime | down | 3 |
| `R-roles-fav` | role-mix | **text** | 0.715 → 0.772 | 0.057 | 0.715 → 0.772 | 1.3x sr_bytes | down | 2 |
| `R-firmware` | profile | **text** | 0.760 → 0.815 | 0.055 | 0.760 → 0.815 | 3.4x bytes_on_air | down | 2 |
| `D-cadence` | trigger | **held** | 0.863 → 0.915 | 0.052 | 0.729 → 0.760 | 18x sr_bytes | down | 4 |
| `R-traceroute` | traceroute-per-hour | **text** | 0.708 → 0.760 | 0.052 | 0.708 → 0.760 | 1.4x sr_airtime | down | 4 |
| `R-versions` | profile | **text** | 0.760 → 0.812 | 0.052 | 0.760 → 0.812 | 3.4x bytes_on_air | down | 5 |
| `R-congestion-input` | congestion-input | **held** | 0.641 → 0.687 | 0.045 | 0.500 → 0.536 | 1.5x sr_airtime | up | 2 |
| `R-signing-cost` | profile-flag | **held** | 0.915 → 0.959 | 0.044 | 0.760 → 0.803 | 3.2x bytes_on_air | down | 2 |
| `Q-hopassign` | hop-assign | **held** | 0.876 → 0.915 | 0.039 | 0.750 → 0.760 | 1.1x sr_airtime | down | 2 |
| `R-srretries` | sr-retries | **held** | 0.892 → 0.924 | 0.032 | 0.748 → 0.758 | 1.2x sr_bytes | down | 4 |
| `J-wincap` | capacity | **held** | 0.889 → 0.919 | 0.030 | 0.758 → 0.766 | 1.9x advert_bytes | up | 3 |
| `G-servers` | servers | **held** | 0.898 → 0.927 | 0.029 | 0.754 → 0.763 | 6.9x sr_bytes | up | 4 |
| `N-servers` | servers | **held** | 0.898 → 0.927 | 0.029 | 0.754 → 0.763 | 6.9x sr_bytes | up | 4 |
| `X-worst` | role-placement | **text** | 0.819 → 0.847 | 0.028 | 0.819 → 0.847 | 1.6x sr_bytes | down | 2 |
| `P-diurnal` | diurnal | **held** | 0.915 → 0.941 | 0.025 | 0.760 → 0.785 | 1.4x sr_bytes | down | 3 |
| `R-dmmode` | dm-mode | **text** | 0.697 → 0.722 | 0.024 | 0.697 → 0.722 | 1.3x sr_airtime | up | 3 |
| `L-provide` | provide-transport | **text** | 0.760 → 0.784 | 0.024 | 0.760 → 0.784 | 2.5x sr_airtime | up | 2 |
| `P-catchup` | catch-up-hours | **text** | 0.732 → 0.755 | 0.023 | 0.732 → 0.755 | 13x sr_bytes | up | 3 |
| `J-window` | window-size | **text** | 0.749 → 0.765 | 0.016 | 0.749 → 0.765 | 6.3x advert_bytes | up | 3 |
| `E-width` | short-id-bits | **held** | 0.911 → 0.925 | 0.014 | 0.757 → 0.768 | 3.2x advert_bytes | up | 4 |
| `E-capacity` | capacity | **held** | 0.903 → 0.915 | 0.012 | 0.751 → 0.760 | 5.3x advert_bytes | up | 5 |
| `M-capacity` | capacity | **held** | 0.903 → 0.915 | 0.012 | 0.751 → 0.760 | 5.3x advert_bytes | up | 5 |
| `R-crladder` | coding-rate-ladder | **text** | 0.711 → 0.722 | 0.011 | 0.711 → 0.722 | 1.1x sr_airtime | down | 2 |
| `D-resolve` | resolve | **held** | 0.904 → 0.915 | 0.011 | 0.753 → 0.760 | 5.7x advert_bytes | = | 3 |
| `J-bucketmode` | bucket-mode | **text** | 0.755 → 0.765 | 0.010 | 0.755 → 0.765 | 3.3x advert_bytes | up | 4 |
| `L-advert` | advert-transport | **text** | 0.751 → 0.760 | 0.009 | 0.751 → 0.760 | 2.7x sr_airtime | down | 2 |
| `R-favourites` | favourite-routers | **text** | 0.751 → 0.760 | 0.009 | 0.751 → 0.760 | 1.1x sr_bytes | up | 2 |
| `D-jitter` | advert-jitter-s | **held** | 0.912 → 0.920 | 0.007 | 0.759 → 0.765 | 1.1x sr_airtime | up | 4 |
| `M-jitter` | advert-jitter-s | **held** | 0.912 → 0.920 | 0.007 | 0.759 → 0.765 | 1.1x sr_airtime | up | 4 |
| `J-timewin` | time-bucket-s | **held** | 0.908 → 0.913 | 0.006 | 0.752 → 0.755 | 5.4x advert_bytes | down | 3 |
| `R-repeats` | extra-repeats | **held** | 0.915 → 0.920 | 0.005 | 0.760 → 0.764 | 1.1x sr_bytes | up | 2 |
| `R-adopt` | no-adopt-hop-recommendation | **text** | 0.954 → 0.959 | 0.005 | 0.954 → 0.959 | 1.2x sr_airtime | down | 2 |
| `M-replayorder` | replay-ordering | **text** | 0.760 → 0.764 | 0.004 | 0.760 → 0.764 | 1.2x sr_bytes | up | 2 |
| `M-combined` | replay-ordering | **text** | 0.784 → 0.787 | 0.003 | 0.784 → 0.787 | 1.1x sr_bytes | up | 2 |
| `R-dmmode-cr` | dm-mode | **text** | 0.711 → 0.714 | 0.003 | 0.711 → 0.714 | 1.1x sr_bytes | up | 2 |
| `G-allrouters` | servers | **held** | 0.873 → 0.874 | 0.001 | 0.748 → 0.749 | 2.8x sr_bytes | down | 2 |
| `R-congestion-mode` | congestion-mode | **text** | 0.959 → 0.959 | 0.001 | 0.959 → 0.959 | 1x bytes_on_air | down | 2 |
| `R-repeats-busy` | extra-repeats | **text** | 0.959 → 0.959 | 0.001 | 0.959 → 0.959 | 1x sr_bytes | up | 2 |
